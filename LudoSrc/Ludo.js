class Dice {
     ...
     roll() {
         ...
         if (this.count == 1) {
             document.getElementById("die").style.backgroundImage = 'url("/LudoSrc/1.png")';
         }
         if (this.count == 2) {
             document.getElementById("die").style.backgroundImage = 'url("/LudoSrc/2.png")';
         }
         if (this.count == 3) {
             document.getElementById("die").style.backgroundImage = 'url("/LudoSrc/3.png")';
         }
         if (this.count == 4) {
             document.getElementById("die").style.backgroundImage = 'url("/LudoSrc/4.png")';
         }
         if (this.count == 5) {
             document.getElementById("die").style.backgroundImage = 'url("/LudoSrc/5.png")';
         }
         if (this.count == 6) {
             document.getElementById("die").style.backgroundImage = 'url("/LudoSrc/6.png")';
         }
         if (this.type == 1) {
             if (this.r.checker()) {
